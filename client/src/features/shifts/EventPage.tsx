    ...
    <div className="flex flex-col gap-3">
      ...
      {!board.event_mode && (
        <div className="rounded-[var(--radius-md)] border border-[var(--color-warning)] px-4 py-2.5 text-[13px] text-[var(--color-warning)]">
          Пока режим события выключен, награды выдавать и разыгрывать нельзя,
          а ростер сюда не наливается. Событие — отдельная смена: у той, что
          ведётся, режим не включится.
        </div>
      )}
