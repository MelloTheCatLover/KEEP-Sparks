...
// Один и тот же клиент, но токен берётся снаружи: у искр он свой, у судьи
// фестиваля — свой (вход по PIN). Смешивать их нельзя, поэтому источник токена
// задаётся при создании клиента.
export function createApi(getAuthToken: () => string | null) {
